...
class PostsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        // aqui usa-se o eloquent em vez do query builder pra que ele armazene
        // os timestamps (created_at, updated_at). created_at é a data de criação do post
        // assim o laravel cria ele automaticamente.
        $items = [];
        ...
        for($i = 0; $i < 50; $i++ ) {
            ...
            // informações de teste, mas são visualizáveis na aplicação.
